...
// Then(/^Verify user is able to receive success message$/, async function () {
//   await this.driver.wait(until.elementLocated(By.xpath(productsPageObjects.completeOrderSuccessMessage())));
//   const el = await this.driver.wait(until.elementLocated(By.xpath(productsPageObjects.completeOrderSuccessMessage())), timeout);
//   assert.exists(el);
// });
